...
<body>
  ...
  <main class="form-signin w-100 m-auto">
    ...
    <div>
      <a href="./choosePeriod.php">
        <button class="btn btn-primary w-100 py-2" type="submit"
          data-nlok-ref-guid="aeaf789e-b250-4308-f552-159fdf94865d">Wybierz nowy okres rozliczeniowy</button></a>
    </div>
    ...
    <div>
      <table class="table table-dark table-hover">
        ...
        <tr>
          ...
          <td>01.01.2023</td>
          <td>100.56</td>
          <td>Bardzo długa kategoria</td>
          <td>Brak jakiegokolwiek komentarza</td>
          <td>gotówka</td>
          <td>
            <a href="./editExpense.php">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                class="bi bi-pencil-fill" viewBox="0 0 16 16">
                <path
                  d="M12.854.146a.5.5 0 0 0-.707 0L10.5 1.793 14.207 5.5l1.647-1.646a.5.5 0 0 0 0-.708zm.646 6.061L9.793 2.5 3.293 9H3.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.207zm-7.468 7.468A.5.5 0 0 1 6 13.5V13h-.5a.5.5 0 0 1-.5-.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.5-.5V10h-.5a.5.5 0 0 1-.175-.032l-.179.178a.5.5 0 0 0-.11.168l-2 5a.5.5 0 0 0 .65.65l5-2a.5.5 0 0 0 .168-.11z" />
