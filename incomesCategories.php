...
try {
  ...
  if ($connection->connect_errno != 0) {
    ...
    $usersQuery = $db->query
    (
      "SELECT id, name FROM incomes_category_assigned_to_users WHERE user_id = $userId"
    );
          ...
          <tr>
            ...
            <td>
              <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                <a href="./editIncomeCategory.php?id=<?= $category['id']; ?>">
            ...
            <td>
              <div class="d-grid gap-2 d-sm-flex justify-content-sm-center"><a href="./incomesCategories.php">
                  <a href="./deleteIncomeCategory.php?id=<?= $category['id']; ?>">
                    <button type="submit" class="btn btn-outline-secondary btn-lg px-4"
                      name="delete_income_category">Usuń</button></a>
              </div>
            </td>
          </tr>
          <?php
